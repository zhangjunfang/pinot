...
public class ParquetTest {
  ...
  public static void singleValuedReadBenchMarkV1(PinotDataBuffer pinotDataBuffer, int numDocs, int columnSizeInBits, String column)
    ...
    //PinotDataBuffer heapBuffer = PinotDataBuffer.fromFile(pinotDataBuffer, ReadMode.heap, FileChannel.MapMode.READ_ONLY, "benchmark");
  ...
  private static void benchmarkForwardIndex(String indexDir, List<String> includeColumns)
    ...
    com.linkedin.pinot.core.segment.store.SegmentDirectory.Reader reader = segmentDir.createReader();
