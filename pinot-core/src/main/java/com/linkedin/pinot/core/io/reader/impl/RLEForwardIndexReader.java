...
public class RLEForwardIndexReader
  ...
  private final FixedByteSingleValueMultiColReader bookMarkReader;
  private final int numDocs;
  private final int bookMarkDistance;

  public RLEForwardIndexReader(FixedByteSingleValueMultiColReader rawFileReader,
      FixedByteSingleValueMultiColReader bookmarkFileReader, int bookMarkDistance,
      int numDocs) {
