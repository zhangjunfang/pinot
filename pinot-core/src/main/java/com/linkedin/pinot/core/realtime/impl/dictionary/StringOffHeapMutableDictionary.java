...
import com.linkedin.pinot.core.io.writer.impl.OffHeapMutableByteArrayStore;
...
public class StringOffHeapMutableDictionary extends BaseOffHeapMutableDictionary {
  ...
  private final OffHeapMutableByteArrayStore _stringStore;
  ...
  public StringOffHeapMutableDictionary(int estimatedCardinality, int maxOverflowHashSize) {
    ...
    _stringStore = new OffHeapMutableByteArrayStore();
  }
  ...
  protected void setRawValueAt(int dictId, Object rawValue, byte[] serializedValue) {
    // TODO
    _stringStore.add(serializedValue);
  }

  @Override
  public Object get(int dictionaryId) {
    return new String(_stringStore.get(dictionaryId));
  }
  ...
  private String getInternal(int dictId) {
    return new String(_stringStore.get(dictId));
  }
  ...
  protected boolean equalsValueAt(int dictId, Object value, byte[] serializedValue) {
    // TODO
    return _stringStore.equalsValueAt(serializedValue, dictId);
  }
