...
public class PinotSchemaRestletResource {
  ...
  public Schema getSchema(
    ...
    try {
      ...
      LOGGER.error("Error reading schema: {}, error:", schemaName, e);
      throw new WebApplicationException("Failed to read schema: " + schemaName, Response.Status.INTERNAL_SERVER_ERROR);
    }
  }
