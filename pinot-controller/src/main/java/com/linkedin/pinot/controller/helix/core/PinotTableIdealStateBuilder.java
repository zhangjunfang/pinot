...
public class PinotTableIdealStateBuilder {
  ...
  private static class KafkaPartitionsCountFetcher implements Callable<Boolean> {
    ...
    public Boolean call() throws Exception {
      ...
      PinotKafkaConsumerFactory _Pinot_kafkaConsumerFactory = new SimpleConsumerFactoryPinot();
      PinotKafkaConsumer consumerWrapper = _Pinot_kafkaConsumerFactory.buildConsumer(bootstrapHosts,
